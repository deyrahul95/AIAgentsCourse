...
def record_user_details(
    ...
    """Record user details with name, email and notes"""
...
class Me:
    ...
    def handle_tool_call(self, tool_calls):
        ...
        for tool_call in tool_calls:
            ...
            print(
                f"⚙️ Tool called: {tool_name}, Arguments: {arguments}",
                flush=True,
            )
            tool = globals().get(tool_name)
            print(f"☑️ Tool: {tool_calls}")
    ...
    def system_prompt(self) -> str:
        system_prompt = (
            ...
            If the user is engaging in discussion, try to steer them towards getting in touch via email; ask for their email and record it using \
            your record_user_details tool."
        )
